...
const es: Dictionary = {
  ...
  legal: {
    ...
    privacyMetaDescription:
      "Cómo Bidvera trata datos personales de cuentas, espacios de trabajo, documentos, facturación, acceso con Google y seguridad en getbidvera.com.",
    termsEyebrow: "Legal",
...
const zh: Dictionary = {
  ...
  legal: {
    ...
    privacyTitle: "隐私政策",
    privacyMetaDescription:
      "Bidvera 如何处理账户、工作区、文档、计费、Google 登录与安全相关的个人数据（getbidvera.com）。",
    termsEyebrow: "法律信息",
    termsTitle: "服务条款",
    termsMetaDescription:
      "Bidvera SaaS 平台使用条款，涵盖账户、AI 输出、订阅与可接受使用。",
    effectiveDateLabel: "生效日期",
    lastUpdatedLabel: "最后更新",
    onThisPage: "本页内容",
    relatedDocuments: "相关链接",
  },
  landing: {
...
const ar: Dictionary = {
  ...
  legal: {
    footerHeading: "قانوني",
    privacyLink: "سياسة الخصوصية",
    termsLink: "شروط الخدمة",
    privacyEyebrow: "قانوني",
    privacyTitle: "سياسة الخصوصية",
    privacyMetaDescription:
      "كيف تعالج بيدفراء البيانات الشخصية للحسابات ومساحات العمل والمستندات والفوترة وتسجيل الدخول عبر كوكول والأمان على getbidvera.com.",
    termsEyebrow: "قانوني",
    termsTitle: "شروط الخدمة",
    termsMetaDescription:
      "شروط استخدام منصة بيدفراء السحابية، بما في ذلك الحسابات ومخرجات الذكاء الاصطناعي والاشتراكات والاستخدام المقبول.",
    effectiveDateLabel: "تاريخ السريان",
    lastUpdatedLabel: "آخر تحديث",
    onThisPage: "في هذه الصفحة",
    relatedDocuments: "ذات صلة",
  },
  landing: {
...
const fr: Dictionary = {
  ...
  legal: {
    footerHeading: "Mentions légales",
    privacyLink: "Politique de confidentialité",
    termsLink: "Conditions d’utilisation",
    privacyEyebrow: "Mentions légales",
    privacyTitle: "Politique de confidentialité",
    privacyMetaDescription:
      "Comment Bidvera traite les données personnelles des comptes, espaces de travail, documents, facturation, connexion Google et sécurité sur getbidvera.com.",
    termsEyebrow: "Mentions légales",
    termsTitle: "Conditions d’utilisation",
    termsMetaDescription:
      "Conditions régissant l’utilisation de la plateforme SaaS Bidvera : comptes, sorties IA, abonnements et usage acceptable.",

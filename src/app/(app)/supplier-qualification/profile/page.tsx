  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 animate-fade-in">
      <div>
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight">Company profile</h1>
        <p className="mt-1 text-sm text-muted">
          Completeness: {profile.completenessPercent}% — required fields only; never AI-inferred.
        </p>
      </div>
